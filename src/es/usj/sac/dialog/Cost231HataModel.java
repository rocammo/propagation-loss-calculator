...
public class Cost231HataModel extends JDialog {
	...
	private void setup() {
		...
		// Result
		label = new JLabel("Result: ", JLabel.TRAILING);
		panel.add(label);
	...
	private String predict() {
		...
		return Cost231HataController.predict(f, d, hb, hm, area).equals("0.0") ? "Out of range"
				: Cost231HataController.predict(f, d, hb, hm, area);
	}
}
