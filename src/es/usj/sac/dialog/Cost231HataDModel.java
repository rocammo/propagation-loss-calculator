...
import es.usj.sac.controller.Cost231HataDController;
import es.usj.sac.util.SpringUtilities;

public class Cost231HataDModel extends JDialog {
	...
	public Cost231HataDModel(JFrame parent) {
		super(parent, "COST231-Hata model (distance)", true);
	...
	private String predict() {
		...
		String result = Cost231HataDController.predict(f, lb, hb, hm, area).replace(',', '.');
